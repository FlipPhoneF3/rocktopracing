...
export const upcomingEvents: RaceEvent[] = [
  {
    ...
    description: 'Waxhaw Trail Fest is a celebration of dirt, grit, and community. Expect punchy climbs, flowing single-track, and festival vibes at the finish line. Whether you are chasing a PR or soaking in the scenery, this course delivers classic Carolina trail running.',
  ...
  },
  {
    ...
    description: 'Inferno turns up the heat with rugged terrain, fast descents, and signature climbs that burn—in the best way. Blaze through pines and ridgelines, then cool off with a finish chute party that rewards every hard-earned mile.',
  ...
  },
  {
    ...
    description: 'Terror Trails is a spooky-good time with twisting forest paths, surprise features, and a course that keeps you on your toes. Family-friendly options meet hair-raising segments for those who dare—come for the thrills, stay for the stories.',
